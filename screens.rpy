...
# ¡Aquí empieza la NUEVA pantalla!
screen resumen_barras():
    tag resumen
    ...
    frame:
        ...
        vbox:
            spacing 15
            label "📊 Estadísticas de la Semana 1" xalign 0.5

            text "Afinidad con Diego:"
            bar value VariableValue("afinidad_diego", 5) xmaximum 300

            text "Afinidad con Matías:"
            bar value VariableValue("afinidad_matias", 5) xmaximum 300

            text "Afinidad con Cristian:"
            bar value VariableValue("afinidad_cristian", 5) xmaximum 300

            text "Afinidad con Joel:"
            bar value VariableValue("afinidad_joel", 5) xmaximum 300

            text "Exploración:"
            bar value VariableValue("exploracion", 5) xmaximum 300

            text "Independencia:"
            bar value VariableValue("independencia", 5) xmaximum 300

            text "Energía:"
            bar value VariableValue("energia", 5) xmaximum 300

            text "Academia:"
            bar value VariableValue("academia", 5) xmaximum 300

            textbutton "Continuar" action Return() xalign 0.5
